...
class DriveSubsystem(Subsystem):
    def __init__(self, maxSpeedScaleFactor=None) -> None:
        ...
        self.frontLeft = SwerveModule(
            drivingCANId=DriveConstants.kFrontLeftDrivingCanId,
            turningCANId=DriveConstants.kFrontLeftTurningCanId,
            chassisAngularOffset=DriveConstants.kFrontLeftChassisAngularOffset * enabledChassisAngularOffset,
            drivingMotorType=SparkMax,
            turningMotorType=SparkMax,
            turnMotorInverted=ModuleConstants.kTurningMotorInverted
        )

        self.frontRight = SwerveModule(
            drivingCANId=DriveConstants.kFrontRightDrivingCanId,
            turningCANId=DriveConstants.kFrontRightTurningCanId,
            chassisAngularOffset=DriveConstants.kFrontRightChassisAngularOffset * enabledChassisAngularOffset,
            drivingMotorType=SparkMax,
            turningMotorType=SparkMax,
            turnMotorInverted=ModuleConstants.kTurningMotorInverted
        )
        ...
        self.rearLeft = SwerveModule(
            drivingCANId=DriveConstants.kRearLeftDrivingCanId,
            turningCANId=DriveConstants.kRearLeftTurningCanId,
            chassisAngularOffset=DriveConstants.kBackLeftChassisAngularOffset * enabledChassisAngularOffset,
            drivingMotorType=SparkMax,
            turningMotorType=SparkMax,
            turnMotorInverted=ModuleConstants.kTurningMotorInverted
        )
        ...
        self.rearRight = SwerveModule(
            drivingCANId=DriveConstants.kRearRightDrivingCanId,
            turningCANId=DriveConstants.kRearRightTurningCanId,
            chassisAngularOffset=DriveConstants.kBackRightChassisAngularOffset * enabledChassisAngularOffset,
            drivingMotorType=SparkMax,
            turningMotorType=SparkMax,
            turnMotorInverted=ModuleConstants.kTurningMotorInverted
        )
    ...
    def getRobotRelativeSpeeds(self) -> ChassisSpeeds:
        ...
        if wpilib.RobotBase.isSimulation():
            # In sim, vendor encoders may not be modeled; use commanded states for better feedback
            states = (
                self.frontLeft.desiredState,
                self.frontRight.desiredState,
                self.rearLeft.desiredState,
                self.rearRight.desiredState,
            )
        else:
            states = (
